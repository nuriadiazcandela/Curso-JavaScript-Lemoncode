...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/Users/nuriadiazcandela/Desktop/BootCamp JS/BootCamp-JavaScript/Modulo-9",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/data-business.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCharactersId = exports.getCharacters = void 0;
...
var getCharacters = function getCharacters() {
  return _axios.default.get('https://www.breakingbadapi.com/api/characters').then(function (response) {
...
var getCharactersId = function getCharactersId(id) {
  return _axios.default.get('https://www.breakingbadapi.com/api/characters/' + id).then(function (response) {
    return response.data;
  });
};

exports.getCharactersId = getCharactersId;
...
var createAvatar = function createAvatar(character) {
  ...
  element.addEventListener('click', function (e) {
    (0, _dataBusiness.getCharactersId)(e.target.id).then(function (charactersId) {
...
},{"./data-business":"src/data-business.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
(0, _dataBusiness.getCharacters)().then(function (users) {
  var nodes = [];
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _node = (0, _utils.createCharacterRow)(user);
...
},{"./styles.css":"src/styles.css","./utils.js":"src/utils.js","./data-business.js":"src/data-business.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
