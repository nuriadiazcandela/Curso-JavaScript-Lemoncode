...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/transfer/transfer.helpers.js":[function(require,module,exports) {
"use strict";
...
},{}],"pages/transfer/custom-validator.js":[function(require,module,exports) {
"use strict";
...
var todayValidation = 'Day validations';
var today = new Date(); // Valida el día

var dayValidator = function dayValidator(theDay) {
  var value = theDay.value;
  var myValue = parseInt(value);
  var validationDayResult = {
    succeeded: false,
  ...
  var giveMeMonth = document.getElementById('month').value;
  var giveMeYear = document.getElementById('year').value;

  if (giveMeYear > today.getFullYear() || giveMeMonth > today.getMonth() + 1) {
    // controlamos que el mes o el año son superiores a los actuales
    if (myValue <= 31) {
      validationDayResult.succeeded = true;
      validationDayResult.message = '';
    }
  } else if (myValue > today.getDate() && myValue <= 31) {
    // si estamos en el mes actual, comprobamos que el día no es superior al actual
    validationDayResult.succeeded = true;
    validationDayResult.message = '';
  }
...
var monthValidator = function monthValidator(theMonth) {
  var value = theMonth.value;
  var myValue = parseInt(value);
  var validationMonthResult = {
    succeeded: false,
    type: todayValidation,
  ...
  if (giveMeYear > today.getFullYear()) {
    ...
    // si el año no es posterior, comprobamos que estamos en un mes posterior
    validationMonthResult.succeeded = true;
    validationMonthResult.message = '';
  }
...
var yearValidator = function yearValidator(theYear) {
  var value = theYear.value;
  var myYearValue = parseInt(value);
  var validationYearResult = {
    succeeded: false,
    type: todayValidation,
...
var _customValidator = require("./custom-validator");

var validationSchema = {
  field: {
    iban: [{
      // validamos el campo IBAN
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _fonk.Validators.pattern,
      customArgs: {
        pattern: /[A-Z]\d{2}[ ]\d{4}[ ]\d{4}[ ]\d{4}[ ]\d{4}[ ]\d{4}|ES\d{22}/
      },
      message: 'Introduzca un número IBAN válido'
    }],
    name: [{
      // validamos el campo Beneficiario
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _fonk.Validators.pattern,
    ...
    day: [{
      // validamos el campo day
      validator: _customValidator.dayValidator
    }],
    month: [{
      // Validamos el campo month
      validator: _customValidator.monthValidator
    }],
    year: [{
      // Validamos el campo year
      validator: _customValidator.yearValidator
    }],
    email: [{
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","./custom-validator":"pages/transfer/custom-validator.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
module.exports = {
  ...
  "_spec": "axios@^0.21.4",
  "_where": "/Users/nuriadiazcandela/Desktop/BootCamp JS/BootCamp-JavaScript/Modulo-12",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTransfer = exports.insertTransfer = void 0;
...
var urlTransfer = "".concat("http://localhost:3000/api", "/transfer");

var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post("".concat(urlTransfer, "/").concat(transfer.id), transfer).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
var getTransfer = function getTransfer() {
...
var _transfer2 = require("./transfer.validations");
...
(0, _helpers.onUpdateField)('select-account', function (event) {
  var value = event.target.value; // recoge el contenido del id correspondiente en la constante value

  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    select: value
  }); // le damos toda la información que tiene actualmente y cambiamos su valor por el recogido en el value

  _transfer2.formValidation.validateField('select-account', transfer.select).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer2.formValidation.validateField('concept', transfer.concept).then(function (result) {
...
var validateDate = function validateDate(day, month, year) {
...
var onSave = function onSave() {
  return (0, _transfer3.insertTransfer)(transfer);
};
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (validateDate(transfer.day, transfer.month, transfer.year)) {
      ...
      alert("Los datos no son correctos. Por favor, revíselos y complete el formulario para realizar la transferencia");
    }
  });
});
},{"../../common/helpers":"common/helpers/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.api":"pages/transfer/transfer.api.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
