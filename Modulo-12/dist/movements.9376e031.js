...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/account/account.api.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"common/helpers/element.helpers.js":[function(require,module,exports) {
"use strict";
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/movements/movements.helpers.js":[function(require,module,exports) {
"use strict";
...
},{}],"pages/movements/movements.api.js":[function(require,module,exports) {
"use strict";
...
var url = "".concat("http://localhost:3000/api", "/movements"); // Seleccionamos el id de la url y lo exportamos
...
},{"axios":"../node_modules/axios/index.js"}],"pages/movements/movements.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapEmptyAccountVmToApi = exports.mapMovementsApiToVm = void 0;
...
var mapMovementsApiToVm = function mapMovementsApiToVm(movements, accountId) {
...
var movementsApiToVm = function movementsApiToVm(moves) {
  // obtenemos los datos de cada movimiento
  return _objectSpread(_objectSpread({}, moves), {}, {
    ...
    amount: "".concat(moves.amount, " \u20AC"),
    //añadimos el símbolo del euro en las cantidades
    balance: "".concat(moves.balance, " \u20AC")
  });
};

var mapEmptyAccountVmToApi = function mapEmptyAccountVmToApi(account) {
...
exports.mapEmptyAccountVmToApi = mapEmptyAccountVmToApi;
...
var giveMeDetailsAccount = Boolean(params.id); // Obtenemos los datos de la cuenta (IBAN y Alias)
...
if (giveMeDetailsAccount) {
  ...
  account = (0, _movements3.mapEmptyAccountVmToApi)(account);
  (0, _helpers.onSetValues)(account);
} // Obtenemos los movimientos de esa cuenta


(0, _movements2.getMovements)().then(function (movements) {
  var vmMovements = (0, _movements3.mapMovementsApiToVm)(movements, params.id); // enviamos todos los movimientos y el id de la cuenta

  if (params.id === undefined) {
    // Si no hay ninguna cuenta seleccionada, devuelve todos los movimientos
    ...
    }; // descartamos los huecos vacios del array


    (0, _movements.addMovementRows)(myMovements(vmMovements)); // los imprimimos por pantalla
  }
});
