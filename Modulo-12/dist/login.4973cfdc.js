...
},{}],"pages/login/login.validations.js":[function(require,module,exports) {
"use strict";
...
var _login2 = require("./login.validations");
...
var onNavigate = function onNavigate(isValid) {
  isValid ? _router.history.push(_router.routes.accountList) : alert('Usuario y/o contraseña no válidos');
};
...
(0, _helpers.onSubmitForm)('login-button', function () {
  _login2.formValidation.validateForm(login).then(function (result) {
    ...
    if (result.succeeded) (0, _login.isValidLogin)(login).then(function (isValid) {
      onNavigate(isValid);
    });
  });
});
